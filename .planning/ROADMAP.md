...
- [x] 06-01-PLAN.md — GameControls + SeatsDisplay unit tests (D-03 / D-04)
...
- [ ] 06-04-PLAN.md — Five scenario tests (join-table, fold/call/raise, avatar, ToS, deposit)
...
| 6. Test Hardening | 3/6 | In Progress|  |
